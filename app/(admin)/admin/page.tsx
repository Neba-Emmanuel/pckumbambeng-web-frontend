...
const adminCards = [
  ...
  {
    title: 'News Sources',
    description: 'Configure the pages aggregated into News',
    href: '/admin/facebook-sources',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Manage church content and settings</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {adminCards.map((card) => (
          ...
          >
            <div className="text-navy-600 mb-3">{card.icon}</div>
